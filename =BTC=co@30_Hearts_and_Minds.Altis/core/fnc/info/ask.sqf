...
switch !(_isInterrogate) do {
    case (_chance < 200) : {_info_type = "NO";}; playSound3d [getMissionPath "core\sounds\gopnik.ogg", _man, false, getPosASL (_man), 5, 1, 10];
    case (_chance >= 200 && _chance < 600) : {_info_type = "FAKE";}; playSound3d [getMissionPath "core\sounds\gopnik.ogg", _man, false, getPosASL (_man), 5, 1, 10];
    case (_chance >= 600) : {_info_type = "REAL";}; playSound3d [getMissionPath "core\sounds\gopnik.ogg", _man, false, getPosASL (_man), 5, 1, 10];
};
